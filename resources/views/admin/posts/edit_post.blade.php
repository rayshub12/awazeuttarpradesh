                                              ...
                                              <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="meta_title" id="post_title" class="form-control" value="{{ $postdetails->meta_title }}">
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="Post Title">Meta Keywords</label>
                                                        <textarea name="meta_keyword" id="meta_keywords" class="form-control">{{ $postdetails->meta_keyword }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="Post Title">Meta Description</label>
                                                        <textarea name="meta_description" id="meta_description" class="form-control">{{ $postdetails->meta_description }}</textarea>
                                                    </div>
                                                </div>
                                              </div>
                                          </div>
