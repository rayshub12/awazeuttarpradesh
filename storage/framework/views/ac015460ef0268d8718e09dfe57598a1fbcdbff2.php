...
<footer class="bg-191 pos-relative color-ccc bg-dark-primary pt-50">
		...
		<div class="container">
			...
			<div class="text-center">
				<div class="row">
					<div class="col-sm-3">
						<a class="mtb-10 logofooter" href="#"><img src="<?php echo e(url('images/frontend/images/logo-black.jpg')); ?>" alt=""></a>
					</div><!-- col-sm-3 -->
					...
					<div class="col-sm-5">
							...
							<a href="<?php echo e(url('privacy-policy')); ?>">Privacy policy</a> | <a href="<?php echo e(url('terms')); ?>">Terms &amp; condition</a>
...
<?php /* /home/brj9ibrcb139/resources/views/layouts/frontLayouts/front_footer.blade.php */ ?>