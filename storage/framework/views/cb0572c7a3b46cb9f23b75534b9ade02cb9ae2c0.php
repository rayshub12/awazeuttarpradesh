        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="alert alert-danger">
                    ...
                    <strong>All fields with * are require</strong>
                </div>
                <?php endif; ?>
                ...
                <div class="box box-purple">
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form method="post" action="<?php echo e(url('/admin/new-post')); ?>" enctype="multipart/form-data" name="add_post" id="add_post" >
                                              ...
                                              <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="meta_title" id="post_title" class="form-control"  >
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="Post Title">Meta Keywords</label>
                                                        <textarea name="meta_keyword" id="meta_keywords" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                ...
                                <div class="col-sm-3 col-md-3 col-lg-3">
                                    ...
                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select name="post_category" id="post_category" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
                                    ...
                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        <div class="form-group btn-justify">
                                            <input type="submit" class="btn btn-info btn-md btn-block" value="Publish" onclick="validateForm()">
                                        </div>
                                    </div>
...
<?php /* /home/brj9ibrcb139/resources/views/admin/posts/add_new_post.blade.php */ ?>